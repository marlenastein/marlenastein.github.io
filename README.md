...
These charts reveal different information about partying trends at Lehigh University. On the left chart, we see what gender prefers what location for parties. On the right chart, we see what percentage of people surveryed from every class have been to an off campus party before. These charts are interesting because while we see a big differences between where men and women prefer to have parties, we can see that 100% of people in survey in each class have still attended at least one off campus party.
